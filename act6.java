...
public class act6 {
    ...
    public static void main(String[] args) {
        ...
        float calif[] = new float[5]; // declaración y creación de array de tipo float para las calificaciones
                                      // individuales
        System.out.println("*** Bienvenido alumno *** \n");
        System.out.println("Introduce tu nombre: ");
        try (//// inicializo un objeto de tipo scanner con el nombre in, para poder leer de
             //// teclado
                Scanner in = new Scanner(System.in)) {
            //// se lee el nombre y se asigna a la variable de tipo String
            nombre = in.nextLine();

            //// Se capturan los datos del array de calificaciones con datos de tipo float a
            //// traves de un bucle for
            for (i = 0; i < 5; i++) {
        ...
        a = prom(calif); // se asigna la devolucion del metodo prom, que regresa un float, a la variable
                         // 'a'. se envia el array de calificaciones
        cal = Calf(a); // se asigna la devolucion del metodo Calf, que regresa un String, a la var
                       // "cal". Se envia el promedio (a)
    ...
    static float prom(float lista[]) // retorna un float y recibe un array de tipo float
    {
        ...
        // en un bucle for se hace la sumatoria de los elementos en el array, el cual se
        // recorre con la variable auxiliar "i"
        for (i = 0; i < 5; i++) {
            sum = sum + lista[i];
        }

        // el resultado de la sumatoria se divide entre 5 y se obtiene el promedio. el
        // cual será retornado por el metodo
        pro = sum / 5;
        return pro;
    }

    //// Metodo que asigna una calificacion con letra segun el promedio numerico
    //// obtenido
    ...
    static void MostrarR(String nombre, float grades[], float promedio, String Cfinal) // no devuelve nada, recibe un
                                                                                       // string para el nombre, array
                                                                                       // de float
